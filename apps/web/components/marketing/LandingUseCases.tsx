  ...
  return (
    <section className="mx-auto mt-16 max-w-7xl px-4 sm:mt-24 sm:px-8 lg:px-10">
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-12 lg:grid-rows-[auto_auto_auto] lg:gap-x-6 lg:gap-y-5">
        ...
        <article className="rounded-2xl border border-slate-200/60 bg-gradient-to-br from-[#eceef0] to-slate-100/80 p-7 lg:col-span-5 lg:col-start-8 lg:row-start-1 lg:self-end lg:p-8">
        ...
        <article className="rounded-r-2xl border-y border-r border-slate-200/70 border-l-[3px] border-l-indigo-600 bg-white py-7 pl-7 pr-6 sm:py-8 sm:pl-9 lg:col-span-10 lg:col-start-1 lg:row-start-3 lg:mt-2">
