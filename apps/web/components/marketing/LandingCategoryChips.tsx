...
const chipClass: Record<(typeof chips)[number]["variant"], string> = {
  ...
  outline:
    "border border-slate-200/80 bg-white text-[#464555] hover:border-indigo-200 hover:bg-indigo-50/80"
};

export function LandingCategoryChips() {
  return (
    <section className="mx-auto mt-14 max-w-7xl px-4 sm:mt-20 sm:px-8">
      <p className="mb-4 text-center text-xs font-medium uppercase tracking-wider text-slate-400 sm:text-left">
        Jump to open work
      </p>
