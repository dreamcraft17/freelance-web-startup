      ...
      <div className="mx-auto max-w-6xl px-4 py-3 sm:px-6">
        <div className="flex flex-wrap items-center gap-2 text-[11px] font-semibold">
          ...
          <span className="inline-flex items-center gap-1.5 text-slate-700">
            <Radar className="h-3.5 w-3.5 text-nw-brand" aria-hidden />
            {t("landing.activity.liveNow")}
          </span>
          <Link href={withIntent("/jobs", intent)} className="rounded-md border border-slate-200 bg-white px-2 py-0.5 text-slate-700 hover:border-nw-brand/45 hover:text-nw-brand">
            {t("landing.activity.activeNow")}
          </Link>
          <Link href={withIntent("/freelancers", intent)} className="rounded-md border border-slate-200 bg-white px-2 py-0.5 text-slate-700 hover:border-nw-brand/45 hover:text-nw-brand">
          ...
          {trendLanes.map(({ labelKey, href }) => (
            <Link
              ...
              className="rounded-md border border-slate-200 bg-white px-2 py-0.5 text-slate-700 transition hover:border-nw-brand/45 hover:text-nw-brand"
            >
              {t(labelKey)}
            </Link>
          ))}
          ...
          <Link
            ...
            className="inline-flex items-center gap-1 rounded-md border border-nw-brand/35 bg-nw-brand/[0.07] px-2 py-0.5 text-nw-brand transition hover:border-nw-brand/60"
          >
