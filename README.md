...
> **Doc revision:** v66  
> Last synchronized: 2026-05-01 — homepage simplified to dual-user minimal mode (recruit/work toggle, dynamic headline/CTA/search, no marketplace list sections).
...
- Homepage kini diposisikan ulang sebagai entry minimal dua-audiens (`Saya ingin rekrut` / `Saya ingin kerja`) dengan headline, CTA, dan search bar dinamis per mode, serta tanpa panel data/list marketplace agar fokus ke aksi utama.
