...
> **Doc revision:** v21  
> Last synchronized: 2026-05-11 (Playwright infra doc `docs/testing-playwright.md` + maintenance table).
...
| Playwright browser E2E / test DB / CI artifacts | `docs/testing-playwright.md`, `README.md` (scripts + quickstart), `packages/database/README.md` if pool/URL guidance |
